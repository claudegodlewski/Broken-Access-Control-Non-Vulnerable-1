...
exports.deleteMessage = (req, res) => {
  ...
  Post.findOne({ _id: req.params.id }).then((a) => {
      /* Si l'userId de l'auteur est identique à celui de l'utilisateur, alors le message est supprimé.
         Si l'utilisateur est administrateur, alors le message est supprimé. */
      if (a.userId == req.auth.userId || req.auth.systemAdministrator == true) {
